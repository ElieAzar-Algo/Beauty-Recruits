...
@section('content')
<!-- Start Banner Area -->
<section class="banner-area ptb-100" style="background-image: url('assets/images/intro-image.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
    <div class="d-table">
