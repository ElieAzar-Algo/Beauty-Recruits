            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    @if(Auth::guard('company')->check() && Auth::guard('company')->id()==$data->company->id)
                        <div class="get-quote">
                            <a href="{{url('job-update/')}}/{{$data->id}}" class="default-btn"
                            ...
                            <div class="col-6">
                                ...
                                <div class="hot-jobs-list">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-4">
                                            <a href="{{url('/view-candidate/'.$i->id.'/job/'.$data->id)}}"
                                               class="default-btn">View Candidate</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <form action="{{url(env('APP_URL').'applicant-answer')}}" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea name="answer" id="answer" cols="113" rows="5" placeholder="Insert your answer"
                              required></textarea>
