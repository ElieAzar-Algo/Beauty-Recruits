                        ...
                        <form class="profile-info" action="{{url(env('APP_URL').'company-update')}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('username', $company->username) }}" class="form-control"
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input value="{{ old('email', $company->email) }}" class="form-control"
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input value="{{ old('phone', $company->phone) }}" class="form-control"
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled
                                               value="{{ old('expertise_name', $company->field_expertise->expertise_name) }}"
                                               class="form-control" type="text" name="expertise_id">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <label>Country</label>
                                        <input value="{{ old('location', $company->location) }}" class="form-control"
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <label>Website</label>
                                        <input value="{{ old('website', $company->website) }}" class="form-control"
