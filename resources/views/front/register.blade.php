    ...
    <div class="row mt-4">
        <div class="col-sm-6 offset-sm-3 d-flex p-2">
            @if(request()->has('type'))
                ...
                @elseif(request()->get('type')=='employers')
                    <button
                        style="height:300px; background-color:#336161 ;  font-size:40px; font-weight:900; color:white"
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required onblur="check_Password(this.value)" id="applicantPassword"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required
                                               onblur="passwords(this.id,'applicantPassword','alertApplicantPassword')"
                                               id="applicantConfirmPassword" class="form-control" type="password"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input style="" required class="form-control" type="number"
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required onblur="check_Password(this.value)" id='companyPassword'
                                               class="form-control" type="password" name="password"
                                               pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                                               title="Password Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Confirm Password </label>
                                        <input required
                                               onblur="passwords(this.id,'companyPassword','alertCompanyPassword')"
                                               id="companyConfirmPassword" class="form-control" type="password"
                                               name="confirm-password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                                               title="Password Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
                                    </div>
                                    <div>
